...
public class BoardFrame extends JFrame implements IBoard {
    ...
    /*
     * (non-Javadoc)
     * @see view.IBoard#addSquare(view.ISquare, int, int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see view.IBoard#addPawn(view.IPawn)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see view.IBoard#setDimension(java.awt.Dimension)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see view.IBoard#setDisplayFrame(java.awt.Rectangle)
     */
    @Override
